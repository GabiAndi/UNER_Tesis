...
En este capítulo se explica el marco tecnológico conceptual en el cual se desarrolló la solución propuesta para un control del velocidad mediante un variador de frecuencia. Para una mejor comprensión y estudio mas en detalle se recomienda leer los libros \cite{CHPM5} y \cite{JFM6}, en los capítulos correspondientes se habla mas en profundidad. \\
...
Pero Big Data no es solo datos, se podría decir que el Big Data se reparte entre los datos y todos los procesos que se agrupan alrededor de estos datos, desde la recogida de los mismos, el almacenamiento y su posterior procesamiento o análisis, todo ello con objetivo de extraer valor de los mismos.