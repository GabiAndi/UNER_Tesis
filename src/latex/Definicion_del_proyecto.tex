...
Desarrollar un sistema de control para la planta de tratamiento de afluentes de EGGER basado en tecnologías de Industria 4.0 para el proceso de aireación de la pileta de lodos activos.
...
El proyecto abarca el diseño y desarrollo de un sistema de control con las carácteristicas anteriormente nombradas incluyendo:
...
\begin{itemize}
    ...
    \item{Configuración de la red operativa del prototipo (IPs, puertos, firewall, servicios, etc).}
...
El proyecto, debido a la complejidad de desarrollo no incluirá una comunicación más alla de TCP/IP, como lo pueden ser profinet, profibus, modbus, etc. \\
