...
Desarrollar un sistema de control basado en tecnologías de Industria 4.0, para el proceso de aireación de la pileta de lodos activos ubicada en la planta de tratamiento de efluentes de la empresa local.
...
\begin{itemize}
    \item{Analizar y comprender el proceso de tratamiento de aguas residuales.}
    ...
    \item{Determinar las variables críticas de control del proceso de lodos activos.}
    \item{Desarrollar un prototipo para realizar pruebas y ensayos buscando demostrar la viabilidad y eficiencia del sistema de control.}
    \item{Escalar el sistema de control a las características de la industria, y generar un presupuesto de la solución.}
    \item{Introducir tecnologías 4.0 en el proceso de tratamiento de efluentes.}
    \item{Proporcionar una infraestructura para el análisis de datos.}
\end{itemize}
...
La construcción del prototipo se centra en la validación del hardware y software. Otros aspectos no son tenidos en cuenta.

La confección de un manual mantenimiento y un procedimiento de puesta en servicio no son desarrollados en este proyecto.