...
La metodología Kanban se implementa por medio de tableros organizados por columnas. Se trata de un método visual de gestión de proyectos que permite a los equipos visualizar sus flujos de trabajo y la carga de trabajo.
...
\begin{enumerate}
    ...
    \end{enumerate}
    \item{Elaboración del prototipo.}
    \begin{enumerate}
        \item{Limitaciones.}
        \item{Construcción.}
    \end{enumerate}
...
Todas las actividades son desarrolladas secuencialmente utilizando la metodología de waterfall. Únicamente en la etapa de diseño de software se empleará un enfoque paralelo tipo scrum.

\subsection{Tiempos de desarrollo}

Llevar adelante el diseño completo de un proyecto de esta magnitud, demanda meses de desarrollo, más si tenemos en cuenta que lo realizan dos Ingenieros Junior cuyo objetivo es mas académico que lucrativo. Se busca aplicar e integrar los conocimientos adquiridos, para generar una propuesta innovadora. Es por esto que consideramos los siguientes plazos:
        ...
        \begin{table}[H]
            ...
            \begin{center}
                \begin{tabular}{|c|c|c|}
                    ...
                    Relevamiento en planta & 32 & \$20.000 \\ \hline
                    Desarrollo de la instalación eléctrica & 160 & \$160.000 \\ \hline
                    Desarrollo de la electrónica & 240 & \$240.000 \\ \hline
                    Desarrollo de software & 860 & \$1.000.000 \\ \hline
                    Pruebas y ensayos & 160 & \$320.000 \\ \hline
                    Instalación y configuración & 80 & \$360.000 \\ \hline
                    && \\ \hline
                    \textbf{Total} & \textbf{1.532} & \textbf{\$2.100.000} \\ \hline
                \end{tabular}
            \end{center}
        \end{table}
    \end{landscape}
        ...
        \begin{table}[H]
            ...
            \begin{center}
                \begin{tabular}{|c|c|c|}
                    ...
                    Materiales & \$2.674.399,22 & \$23.768,21 \\ \hline
                    Costos de desarrollo & \$2.100.000,00 & \$18.663,35 \\ \hline
                    && \\ \hline
...

{
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=.46]{src/imagenes/prototipo/variadorConfiguracion.png}
    \end{figure}

    \newpage
}

\subsubsection{Motor trifásico}
