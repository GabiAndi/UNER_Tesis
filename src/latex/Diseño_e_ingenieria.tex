...
\begin{itemize}
    \item{Primera consideración.}
\end{itemize}

\pendiente{Consideraciones para esquema eléctrico}

Los planos y los esquemas finales se encuentran en el anexo \ref{anexo:planosElectricos}.

\subsubsection{Componentes seleccionados}

\pendiente{Componentes eléctricos seleccionados}
...
\pendiente{Simulación del modelo matemático}
...
\pendiente{Fotos del GUI\_SCPA}

\pendiente{Fotos del SIMOD}

\pendiente{Fotos de Grafana}

\pendiente{Fotos del variador y las conexiones}