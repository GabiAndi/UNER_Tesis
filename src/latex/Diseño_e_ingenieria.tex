...
Llevar cabo un desarrollo completo del sistema se extiende un poco, más si tenemos en cuenta que lo realizan dos Ingenieros Junior. Con esto en cuenta, consideramos los siguientes plazos:
...
Es sistema de aireación está compuesto por la etapa de suministro de aire, de distribución de aire y expulsión de aire. Podrá ver una descripción más detallada en el anexo \ref{anexo:caracteristicasDelSistema}.
        ...
        \begin{table}[H]
            ...
            \begin{center}
                \begin{tabular}{|c|c|c|c|c|c|}
                    \hline
                    \multicolumn{6}{|c|}{Presupuesto} \\ \hline
