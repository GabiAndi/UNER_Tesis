...
En este proyecto, se plantea el desarrollo de un sistema de control de oxigeno disuelto en la pileta de lodos activos de la planta de tratamiento de aguas residuales de la empresa de Egger en Concordia, ubicada en el parque industrial. Actualmente, el sistema de aireación no posee un sistema de control automático.
