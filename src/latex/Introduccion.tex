...
En este capítulo se aborda, de una manera más técnica y económica, el diseño de la solución. Se propone una metodología de trabajo basada en soluciones alternativas de control para este tipo de sistemas, ya sea comerciales o desarrollos personalizados. El análisis económico inicial y el análisis de impacto.
...
La planificación y el diseño detallado del sistema de control, y la construcción de un prototipo se encuentran en este capítulo.
...
Culminado con el desarrollo, se expone los resultados obtenidos de todo el proceso y variaciones en la estimación de los cálculos técnicos y económicos.