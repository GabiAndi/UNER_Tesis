...
Ubicada en Concordia, Entre Ríos, existe una industria que se dedica a la elaboración de productos a base de madera. La planta es un complejo productivo donde se fabrican y distribuyen tableros de fibra de madera (MDF), tableros de aglomerado (PB), Melamina, Molduras y Revestimientos.
