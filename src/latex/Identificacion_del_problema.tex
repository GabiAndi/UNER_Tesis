...
Todos estos inconvenientes hacen que un sistema que controle el proceso y que proporcione métricas de como lo esta haciendo, sea altamente necesario. Además, si ocurre una situación de error en la que el operario tenga que intervenir, y justo este problema ocurre a la noche, el personal no se daría cuenta hasta el día siguiente. Con lo cuál un control a distancia también es necesario.