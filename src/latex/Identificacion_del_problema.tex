...
Permite al operario modificar los valores del proceso de una forma rápida y sencilla, ya sea desde su celular o cualquier dispositivo. Esto es especialmente útil durante el horario nocturno, en donde el personal de la planta es mínimo y si sucede algún percance, pasarán horas hasta que sea notificado. En un proceso biológico esto no debiera ocurrir, ya que la población de microorganismos se va a ver afectada. \\

Dentro de las mejoras se encuentran:

\begin{itemize}
    \item{\textbf{Eficiencia:} el control dinámico del ventilador y bombas dosificadoras de acuerdo con la demanda de oxígeno disuelto permite un potencial de ahorro energético significativo.}
    \item{\textbf{Prevención de roturas:} el control de velocidad de los sopladores garantiza un arranque suave y de poco impacto en los demás procesos, ademas de disminuir en gran medida es estrés al cual se somete la cañería.}
    ...
    \item{\textbf{Flexibilidad:} el control de oxígeno disuelto y de otros parámetros de la planta pueden modificarse y configurarse según los requerimientos. Ademas, permite ampliar la capacidad de control y toma de variables si fuese necesario.}
    \item{\textbf{Sin riesgos:} integrado rápido y fácil en los sistemas de control de procesos existentes en manera paralela, es decir, cada sistema de control es un módulo independiente que puede extraerse o anularse ante cualquier imprevisto, permitiendo así continuar con el funcionamiento normal del proceso.}
