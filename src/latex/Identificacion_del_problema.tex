...
La planta de EGGER en Concordia, está ubicada en el Parque Industrial, es un complejo productivo de 360.000 $m^2$ y más de 50.000 $m^2$ cubiertos, donde se fabrican y distribuyen más de 500.000 $m^3$ anuales de tableros de fibra de madera (MDF), tableros de aglomerado (PB), Melamina, Molduras y Revestimientos, abasteciendo a Argentina, el Mercosur, EE.UU. y Canadá. 

\begin{figure}[H]
    \centering
    \includegraphics[scale=.7]{src/imagenes/industria/eggerConcordia.jpg}
    \caption{Planta industrial en Concordia.}
\end{figure}
