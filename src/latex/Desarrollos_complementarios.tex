...
El filtro canasto está colgado debajo del vertedero y posee un sistema de críquet para izamiento. De esta manera el operador procede a retirar los sólidos. \\
...
Allí recibe la dosificación del policloruro de Aluminio (PAC) y posteriormente la dosis de hidróxido de sodio (soda cáustica). Luego ingresa a la primera cámara de reacción llamada flash-mix.
...
Las aguas provenientes del tratamiento fisicoquímico y el filtrado proveniente de la deshidratación de lodo se recolectan en el foso de aguas claras. Estos líquidos contienen materia orgánica, en gran medida en forma soluble, la cual deberá ser eliminada en el tratamiento secundario de tipo biológico. \\
...
Actualmente, para medir el OD, la empresa EGGER tiene el sensor DissolvedOxygenMonitor Model Q46D:
